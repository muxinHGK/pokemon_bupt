...
void fight1::getpetfrommain1(QString str1, QString str2, int a, int b, int c)
{
    this->mytype=a;
    this->mylevel=b;
    this->myexp=c;
    ...
    ui->lineEdit_13->setText(yourpetname);
    ui->lineEdit_14->setText(yourpettype);
    ui->lineEdit_15->setText(QString::number(yourlevel,10));
    ui->lineEdit_16->setText(QString::number(yourattack,10));
    ui->lineEdit_17->setText(QString::number(yourdefense,10));
    ui->lineEdit_18->setText(QString::number(yourlife,10));
    ui->lineEdit_19->setText(QString::number(yourspeed,10));
    ui->lineEdit_20->setText(QString::number(yourexp,10));
}

//----------------------------startfight1-------------------------------------------------

void fight1::startfight1()
{
    QTime time;
    ...
    ui->lineEdit_12->setText(QString::number(mynowlife,10));
    ui->lineEdit_21->setText(QString::number(yournowlife,10));
    ...
    if(mynowlife>0)
    {
        ...
        emit winfight1(1,mylevel,myexp,yourtype,yourlevel);
        QMessageBox::information(this,"message","你赢了！");
        //emit getyourpet(yourtype,yourlevel);
    }
    else if(yournowlife>0)
    {
        ...
        emit losefight1(0,mylevel,myexp);
        //emit losemypet();
...
void fight1::on_lineEdit_10_editingFinished()
{
    this->yourtype=ui->lineEdit_10->text().toInt();
}

void fight1::on_lineEdit_11_editingFinished()
{
    this->yourlevel=ui->lineEdit_11->text().toInt();
}

void fight1::on_lineEdit_9_editingFinished()
{
    this->mypetid=ui->lineEdit_9->text();
}

void fight1::on_pushButton_clicked()
{
    emit getpet1(mypetid);
    ui->pushButton_2->setEnabled(true);
}

void fight1::on_pushButton_2_clicked()
{
    startfight1();
}

void fight1::paintEvent(QPaintEvent *)
{
    QPainter *painter=new QPainter(this);
    QPixmap pix;
    pix.load("C:/Users/Administrator/Desktop/PokemonGo/pokemon3/picture/1ce922e852a738d1.jpg");
